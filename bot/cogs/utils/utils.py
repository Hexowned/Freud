...
class Utils(Cog):
    ...
    async def pep_command(self, ctx: Context, pep_number: str) -> None:
        ...
        for extension in possible_extensions:
            ...
            if response.status == 200:
                ...
                # Now add the interesting information
    ...
    @command()
    @in_channel(Channels.bot, bypass_role=STAFF_ROLES)
    async def charinfo(self, ctx: Context, *, characters: str) -> None:
        """Show you information on up to 25 unicode characters."""
    ...
    async def mention(self, ctx: Context, *, role: Role) -> None:
        ...
        await ctx.send(
            f"{role} has been made mentionable. I will reset in in {human_time}, or when someone mentions this role."
        )
        ...
        try:
            ...
            await ctx.send(f"{ctx.author.mention}, you took too long. I have reset {role} to be mentionable.")
            return
